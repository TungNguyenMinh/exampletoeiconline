...
<head>
    ...
    <script type="text/javascript" src="<c:url value="/template/admin/js/global_script.js"/>"></script>
    <link rel="stylesheet" href="<c:url value="/template/admin/css/global_style.css"/>">--%>
