package com.minhtung.core.data.daoimpl;

import com.minhtung.core.web.common.constant.CoreConstant;
...
public class AbstractDao<ID extends Serializable, T> implements GenericDao<ID, T> {
    ...
    public Object findeByProperty(String property, Object value, String sortExpession, String sortDirection, Integer offset, Integer limit) {
        List<T> list = new ArrayList<T>();
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction transaction = session.beginTransaction();
        Object totalItem = 0;
        try {
            ...
            if (sortExpession != null && sortDirection != null) {
                sql1.append(" order by ").append(sortExpession);
